                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" id="pfname" name="docfname" placeholder="First Name" class="form-control">
                                                <label for="pmname">Middle Name</label>
                                                <input type="text" id="pmname" name="docmname" placeholder="Middle Name" class="form-control">
                                                <label for="plname">Last Name</label>
                                                <input type="text" id="plname" name="doclname" placeholder="Last Name" class="form-control">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="docaddress" name="paddress" class="form-control">
                                            </div>
                                            <div class="form-group">
