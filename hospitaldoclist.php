        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#adddoc">Add new</button>
                      <div class="modal fade bd-example-modal-lg" id="adddoc" tabindex="-1" role="dialog" aria-labelledby="deptModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="deptModalLabel">Add Doctors</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" id="docfname" name="docfname" placeholder="First Name" class="form-control">
                                                <label for="docmname">Middle Name</label>
                                                <input type="text" id="docmname" name="docmname" placeholder="Middle Name" class="form-control">
                                                <label for="doclname">Last Name</label>
                                                <input type="text" id="doclname" name="doclname" placeholder="Last Name" class="form-control">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                          <div class="form-group">
                                            ...
                                            <input type="text" id="docaddress" name="docaddress" class="form-control">
                                          </div>
                                          <div class="form-group">
                                            <label for="doccontact">Contact</label>
                                            <input type="number" id="doccontact" name="doccontact" class="form-control">                                                
                                          </div>
                                          <div class="form-group">
                                            <label for="docbloodgroup">Blood Group</label>
                                            <input type="text" id="docbloodgroup" name="docbloodgroup" class="form-control">
                                          </div>
                                          <div class="form-group">
                                            <label for="docage">Age</label>
                                            <input type="text" id="docage" name="docage" class="form-control">
                                          </div>
                                        </div>
                                        <div class="col-sm-4">
                                          <div class="form-group">
                                            <label for="docsex">Sex</label>
                                            <input type="text" id="docsex" name="docsex" class="form-control">
                                          </div>
                                          <div class="form-group">
                                            <label for="docdepartment">Department</label>
                                            <select class="form-control" id="docdepartment" name="docdepartment">
                                            ...
                                            <div class="form-group">
                                                <label for="docprofile">Profile</label>
                                                <textarea class="form-control" placeholder="Enter qualification and specialization" id="docprofile" rows="3" rows="10"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="docpic">Choose a profile picture:</label>
                                                <input type="file" id="docpic" class="form-control-file border" name="docpic">
                                          </div>
                                        </div>
                                    </div>
                                </form>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <table id="doc_list" class="display" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Doc ID</th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>_____</td>
                                    <td>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#adddoc">Edit</button>
                                        <div class="modal fade bd-example-modal-lg" id="adddoc" tabindex="-1" role="dialog" aria-labelledby="deptModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                    <label for="doccontact">Contact</label>
                                                                    <input type="number" id="doccontact" name="doccontact" class="form-control">                                                </div>
                                                                    <div class="form-group">
                                                                    <label for="docbloodgroup">Blood Group</label>
                                                                    <input type="text" id="docbloodgroup" name="docbloodgroup" class="form-control">
                                                                    </div>
