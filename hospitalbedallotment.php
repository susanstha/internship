    ...
    <div id="content-wrapper">
      <div class="jumbotron jumbotron-fluid">
          <div class="container-fluid">
              <div class="row">
                  <div class="col-sm-8">
                    <h3>List of Alloted Beds</h3>
                  </div>
                  <div class="col-sm-4">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#allocate">Allocate Bed</button>
                      <div class="modal fade" id="allocate" tabindex="-1" role="dialog" aria-labelledby="deptModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="deptModalLabel">Add Allotment</h5>
                                ...
                                <div>
                                    <form action="">
                                        <div class="form-group">
                                            <label for="bedcategory">Category</label>
                                            <input type="text" id="bedcategory" name="bedcategory" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="bednumber">Bed Number</label>
                                            <input type="number" id="bednumber" name="bednumber" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="bedpname">Patient Name</label>
                                            <input type="text" id="bedpname" name="bedpname" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="bedalloteddate">Alloted Date</label>
                                            <input type="datetime-local" id="bedalloteddate" name="bedalloteddate" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="beddischargedate">Discharge Date</label>
                                            <input type="datetime-local" id="beddischargedate" name="beddischargedate" class="form-control">
                                        </div>
                                    </form>
                                </div>
                            </div>
              ...
              <div class="tab-content" id="nav-tabContent">
                  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                      <table id="allotment_list" class="display" style="width:100%">
                          <thead>
                              <tr>
                                  <th>S.N.</th>
                                  <th>Category</th>
                                  <th>Bed Number</th>
                                  <th>Patient Name</th>
                                  <th>Bed Alloted Date & Time</th>
                                  <th>Bed Discharge Date & Time</th>
                                  <th>Options</th>
                              </tr>
                          </thead>
                          <tbody>
                                <tr>
                                    ...
                                    <td>_____</td>
                                    <td>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#allocate">Edit</button>
                                        <div class="modal fade" id="allocate" tabindex="-1" role="dialog" aria-labelledby="deptModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="deptModalLabel">Edit Allotment</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
